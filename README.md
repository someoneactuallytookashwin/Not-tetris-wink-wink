...
- Works on **desktop** (keyboard controls) and **mobile** (on-screen buttons)  
...
### Mobile  
- Use the on-screen **D-Pad** & **buttons** inside the Game Boy shell.  
...
- **Hosted on Vercel** for quick deploys  
...
Clone the repo:  
```bash
git clone https://github.com/your-username/not-tetris.git
cd not-tetris
```
